...
<p align="center"><img src="../_screenshots/vault3.png" alt="vault3.png"></p>
...
&emsp;&emsp;`vault login -no-print -method=userpass username=foo` - allows for interactive login using userpass auth method without printing the token
